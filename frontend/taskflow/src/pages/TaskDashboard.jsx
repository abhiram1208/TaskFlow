  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <form
        ...
        className="bg-white rounded-3xl shadow p-8 mb-10"
      >
        <h3 className="text-xl font-semibold mb-6">
          {editingTask ? 'Edit Task' : 'Create New Task'}
        </h3>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <Column
          ...
          color="text-red-600"
          tasks={highTasks}
          {...{ toggleComplete, deleteTask, startEdit }}
        />
...
/* 🔹 COLUMN COMPONENT */
function Column({ title, color, tasks, toggleComplete, deleteTask, startEdit }) {
  return (
    <div>
...
/* 🔹 TASK CARD */
function TaskCard({ task, toggleComplete, deleteTask, startEdit }) {
  return (
    <div className="bg-white rounded-2xl shadow p-5 flex items-start gap-3 hover:shadow-md transition">
